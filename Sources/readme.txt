...
2. Extract the dynamic library (e.g. egtbprobe.dll) file from the distribution and add it to the java library path, so the JVM is able to load it.
...
Current version supports win32 only.
Your contribution in the creation of dynamic library for win64 and linux is very welcome! 
